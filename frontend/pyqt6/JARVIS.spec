...
binaries = []
hiddenimports = ['uuid', 'datetime', 'dataclasses', 'enum', 'typing', 'json', 'threading', 'queue', 'time', 'pathlib', 'logging', 'platform', 'webbrowser', 'http.server', 'socketserver', 'urllib.parse', 'subprocess', 'websocket', 'websocket._abnf', 'websocket._app', 'websocket._core', 'websocket._exceptions', 'websocket._handshake', 'websocket._http', 'websocket._logging', 'websocket._socket', 'websocket._ssl_compat', 'websocket._url', 'websocket._utils', 'utils.theme_manager', 'utils.path_utils', 'views.main_window', 'views.floating_button', 'views.chat_widget', 'views.dashboard_widget', 'views.recommendations_widget', 'views.settings_widget', 'views.toast_notification', 'views.dialogs', 'views.dialogs.login_dialog', 'views.dialogs.survey_dialog', 'views.dialogs.folder_dialog', 'services.api_client', 'services.websocket_client', 'controllers.auth_controller', 'controllers.chat_controller', 'controllers.file_controller', 'models.message', 'models.recommendation', 'models.user']
